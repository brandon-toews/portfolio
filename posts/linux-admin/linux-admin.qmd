...
- ldap
date: "2022-06-17"
description: Project to design and setup a prototype network using headless CentOS 7.0 servers and to produce documentation along with it.
toc: true
...
The scope of the project involves an examination of the current network to
ascertain where it can be improved. In addition, design and implemention of a
prototype network to demonstrate what it could look like after the proposed
upgrades. The proposed solutions must include detailed configurations and
address potential growth of the business in the future.
...
### NFS {.unnumbered}
[https://www.itzgeek.com/how-tos/linux/centos-how-tos/how-to-setup-nfs-server-on-centos-7-rhel-7-fedora-22.html](https://www.itzgeek.com/how-tos/linux/centos-how-tos/how-to-setup-nfs-server-on-centos-7-rhel-7-fedora-22.html)

### NFS - Windows {.unnumbered}
[https://it.umn.edu/services-technologies/how-tos/network-file-system-nfs-mount-nfs-share](https://it.umn.edu/services-technologies/how-tos/network-file-system-nfs-mount-nfs-share)

### LDAP {.unnumbered}
[https://www.itzgeek.com/how-tos/linux/centos-how-tos/step-step-openldap-server-configuration-centos-7-rhel-7.html](https://www.itzgeek.com/how-tos/linux/centos-how-tos/step-step-openldap-server-configuration-centos-7-rhel-7.html)

### LDAP Local User Migration {.unnumbered}
[https://www.itzgeek.com/how-tos/linux/centos-how-tos/migrate-local-users-ldap-accounts.html](https://www.itzgeek.com/how-tos/linux/centos-how-tos/migrate-local-users-ldap-accounts.html)

### LDAP Automount Home Directories {.unnumbered}
[https://www.myfaqbase.com/q0001874-Software-OS-Unix-Linux-RHEL-7-RHCSA-How-to-configure-AutoFS-to-mount-user-home-directories-from-NFS-server.html](https://www.myfaqbase.com/q0001874-Software-OS-Unix-Linux-RHEL-7-RHCSA-How-to-configure-AutoFS-to-mount-user-home-directories-from-NFS-server.html)

### LDAP TLS {.unnumbered}
[https://www.golinuxcloud.com/configure-openldap-with-tls-certificates/](https://www.golinuxcloud.com/configure-openldap-with-tls-certificates/)

### Samba {.unnumbered}
[https://linuxize.com/post/how-to-install-and-configure-samba-on-centos-7/](https://linuxize.com/post/how-to-install-and-configure-samba-on-centos-7/)

### Postfix Server {.unnumbered}
[https://www.server-world.info/en/note?os=CentOS_7&p=mail](https://www.server-world.info/en/note?os=CentOS_7&p=mail)

### Dovcote Server {.unnumbered}
[https://www.server-world.info/en/note?os=CentOS_7&p=mail&f=2](https://www.server-world.info/en/note?os=CentOS_7&p=mail&f=2)