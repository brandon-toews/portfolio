...
- optimization
date: "2023-06-09"
description: Project to train a deep learning model to correctly identify a wasp or a bee using transfer learning with the fastai library.
toc: true
...
![](VideoPresentation.mp4){#video-walkthrough}

## References {.unnumbered}

### Optimization Library {#optimization-library .unnumbered}
